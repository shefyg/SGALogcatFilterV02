from LogcatFilterConsts import LOG_ID_WORKFLOW


class WorkFlowSpecificFilter():

    def __init__(self, log_id=None, sub_line_patterns=[]):
        # Using specific params for this class
        self.log_id = LOG_ID_WORKFLOW
        self.sub_line_patterns = ['WorkFlow', 'HandleScanFinishedWithNode:']
