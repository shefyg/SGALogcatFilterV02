...
class FilterConfigWin(tk.Toplevel):
    def __init__(self, parent, set_filter_callback, filter_config: BaseFilterConfig, *args, **kwargs):
        ...
        self.filter_name_label.grid(row=0, column=0, padx=5, pady=5, sticky='w')

        self.filter_name_entry = tk.Entry(self)
        self.filter_name_entry.grid(row=0, column=1, padx=5, pady=5, sticky='ew')
        ...
        self.sub_filters_label.grid(row=1, column=0, padx=5, pady=5, sticky='w')

        self.sub_filters_entry = tk.Entry(self)
        self.sub_filters_entry.grid(row=1, column=1, padx=5, pady=5, sticky='ew')
        if filter_config:
        ...
        self.color_button.grid(row=2, column=0, columnspan=2, padx=5, pady=5)

        self.selected_color_label = tk.Label(self, text="Selected Color: None")
        self.selected_color_label.grid(row=3, column=0, columnspan=2, padx=5, pady=5)
        if filter_config:
